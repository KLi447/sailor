...
def _add_training_args(parser):
    ...
    group.add_argument('--enable-lora', type=bool, required=False, default=False, help='Enable/Disable LoRA fine tuning.')
    group.add_argument('--lora-config-file', type=str, default=None, help='Path to the LoRA configuration JSON file.')
    group.add_argument('--use-triton-lora', type=bool, default=False, help='If set to True, use optimized Triton kernel for batched LoRA.')
