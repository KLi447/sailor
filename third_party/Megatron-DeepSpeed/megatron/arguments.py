...
def _add_training_args(parser):
    ...
    group.add_argument('--enable-lora', action='store_true', help='Enable/Disable LoRA fine tuning.')
    group.add_argument('--lora-config-file', type=str, default=None, help='Path to the LoRA configuration JSON file.')
    group.add_argument('--use-triton-lora', action='store_true', help='If set, use optimized Triton kernel for batched LoRA.')
